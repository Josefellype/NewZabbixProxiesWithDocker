...
echo "[PREPARE] Passo 0: Aplicando alterações de ajustes finos e personalização"
...
O "Script_sysctl" que é instalado e executado pelo script de preparação está assim:
# ===================================================================
